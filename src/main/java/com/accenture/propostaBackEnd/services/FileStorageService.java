...
import com.accenture.propostaBackEnd.resources.exception.FileStorageException;
import com.accenture.propostaBackEnd.resources.exception.MyFileNotFoundException;
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            if(fileName.contains("..")) {
                throw new FileStorageException("Desculpe! O nome do arquivo contém um caminho inválido " + fileName);
            }
